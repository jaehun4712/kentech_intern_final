...
# 모든 회귀 모델에 사용할 독립 변수(X)를 여기서 정의합니다.
# SettingWithCopyWarning을 피하기 위해 .copy()를 사용합니다.
X_poly = df_result[['X1', 'X2']].copy()
